...
export default function Question({
  ...
  return (
    <li className="question">
      ...
      {expanded ? <div className="question__close" onClick={shrink}>x</div> : null}
      {expanded ? (
        <div className="question__expand">
          ...
          <div className="question__new-answer">
            ...
            <textarea className="question__new-answer__textarea" onChange={answerInputWatcher} value={answerInput} />
